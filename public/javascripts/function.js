...
function zoomIt(factor) {
  ...
  for (var i in objects) {
      var scaleX = objects[i].objObject.scaleX;
      var scaleY = objects[i].objObject.scaleY;
      var left = objects[i].objObject.left;
      var top = objects[i].objObject.top;
      ...
      objects[i].objObject.scaleX = tempScaleX;
      objects[i].objObject.scaleY = tempScaleY;
      objects[i].objObject.left = tempLeft;
      objects[i].objObject.top = tempTop;

      objects[i].objObject.setCoords();
  }
  canvas.renderAll();
  canvas.calcOffset();
}
